...
follower_right_arm_config = SO100FollowerConfig(port="/dev/ttyACM1", id="follower_right_arm", use_degrees=True)

leader_right_arm_config = SO100LeaderConfig(port="/dev/ttyACM2", id="leader_right_arm")

# Initialize the robot and teleoperator
follower = SO100Follower(follower_right_arm_config)
leader = SO100Leader(leader_right_arm_config)
