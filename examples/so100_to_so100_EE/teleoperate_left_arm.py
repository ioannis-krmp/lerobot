...
follower_left_arm_config = SO100FollowerConfig(port="/dev/ttyACM0", id="follower_left_arm", use_degrees=True)

leader_left_arm_config = SO100LeaderConfig(port="/dev/ttyACM3", id="leader_left_arm")

# Initialize the robot and teleoperator
follower = SO100Follower(follower_left_arm_config)
leader = SO100Leader(leader_left_arm_config)
