#!/usr/bin/env python
"""
Test trained ACT policy on bimanual robot.

Usage:
    python test_act_live.py --checkpoint 230000
    python test_act_live.py --checkpoint last
"""
...
def main():
    parser = argparse.ArgumentParser(description="Test ACT model on robot")
    parser.add_argument(
        "--checkpoint",
        type=str,
        default="230000",
        help="Checkpoint to load (e.g., '230000' or 'last')",
    )
    parser.add_argument(
        "--model_dir",
        type=str,
        default="outputs/act_bimanual_70ep",
    ...
    print("=" * 80)
    print("TESTING ACT POLICY ON BIMANUAL ROBOT")
    print("=" * 80)
